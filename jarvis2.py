...
#                 choice=engine.say("Do you want to continue reading? ")
#                 engine.runAndWait()
#                 if 'yes' in choice:
...
class MainThread(QThread):
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            #     speak("Mam please tell me the time to set alarm.")
            #     tt=self.takecommand()
            ...
            elif "how are you jarvis" in self.query or "How you doing jarvis" in self.query:
            ...
            elif "goodbye" in self.query or "offline" in self.query or "bye" in self.query:
